namespace _10.NonAdjacentEmptyCells
{
    using System;
    ...
    public class Program
    {
        ...
        public static void FindElements(string[,] labyrinth, Point startingPoint)
        {
        ...
        public static void FindAllEmptyCells(string[,] labyrinth)
        {
            for (int i = 0; i < labyrinth.GetLength(0); i++)
            {
                for (int j = 0; j < labyrinth.GetLength(1); j++)
                {
                    if (labyrinth[i, j] == " ")
                    {
                        FindElements(labyrinth, new Point(i, j));
                    }
                }
            }
        }
